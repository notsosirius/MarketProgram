...
/**
 * Servlet implementation class DeleteSalerSearchServlet
 */
@WebServlet("/DeleteSalerSearchServlet")
public class DeleteSalerSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteSalerSearchServlet() {
        super();
