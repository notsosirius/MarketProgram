 ...
 */
@WebServlet("/saler/alter/search")
public class AlterSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/saler/product/alter.jsp").forward(request, response);
	}
