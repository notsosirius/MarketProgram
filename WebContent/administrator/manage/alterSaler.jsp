			...
			<div class="col-xs-10">
				<div class="panel">
					...
					<div class="col-xs-4" id="search">
						<form action="${ctx}/AlterSalerSearchServlet" method="post">
							<div class="input-group">
								<input type="text" name="salerkeyword" id="salerkeyword" class="form-control" placeholder="商品搜索" />
						...
						<tbody>
							<c:forEach items="${page.items}" var="pro">
								<tr>
									...
									<td class="text-center"><a href="${ctx}/AlterSalerServlet?id=${pro.id}">修改</a></td>
								</tr>
							</c:forEach>
						</tbody>
 						<tfoot>
